...
/*   Updated: 2025/01/16 13:38:26 by bportell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	//por fim, tenho que tomar cuidado com problemas como o read = 0, ou o fd ser = 0, as coisas precisam existir.
	//confesso que as condiçoes de qnd executar e qnd não ainda estão confusas pra
	//mim, então vou tentar ler mais codigo de outras pessoas e entender o que 
	//elas lidam.
}
